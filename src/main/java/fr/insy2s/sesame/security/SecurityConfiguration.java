...
import fr.insy2s.sesame.config.JwtAuthenticationFilter;
 ...
 * @RequiredArgsConstructor Lombok annotation to inject required dependencies via constructor.
 * @EnableMethodSecurity Enables method-level security annotations (e.g., @Secured, @RolesAllowed).
 */
@Configuration
@EnableWebSecurity
