...
/**
 * ApplicationConfig class provides configuration for authentication and security.
 * It defines beans for user details service, authentication provider, authentication manager,
